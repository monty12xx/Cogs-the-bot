...
class Owner:
    ...
    @commands.command()
    async def info(self):
        """Shows info about T3D"""
        author_repo = "https://discordapp.com/oauth2/authorize?client_id=234179578229293057&scope=bot&permissions=536083519"
        red_repo = author_repo + "V9-DiscordBot"
        server_url = "https://discord.gg/tqjWemK"
        ...
        about = (
            "This is an instance of [T3D- An pupblic bot that you can invite]({}) "
            "created by [Teddy, dangerous]({}) and improved by teddy.\n\n"
            "T3D is a moderator bot and fun , etc"
        ...
        embed.add_field(name="About T3D", value=about)
        embed.set_footer(text="powered by T3D".format(name), icon_url=avatar)
    ...
    async def uptime(self):
        ...
        em = discord.Embed(description='uptime -> ***{} Days {} Hours And {} Minutes *** '.format(str(days), str(hours), str(minutes)), colour=discord.Colour(value=colour))
        await self.bot.say(embed=em)

    @commands.command()
    async def version(self):
        """Shows V9's current version"""
