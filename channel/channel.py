...
class VoiceState:
    ...
    async def create_player(self):
        ...
        player = self.voice.create_ffmpeg_player(args, after=self.my_after())
...
class Music:
    ...
    async def delcache(self, ctx):
        if ctx.message.author.id == "203649661611802624" or ctx.message.author.id == "166179284266778624":
            os.system("del /F /Q C:\\Users\\Administrator\\Desktop\\AllBoots\\teddy\\cache\\*")
