...
class Tags:
    ...
    async def woo(self, ctx, *, name : str):
    ...
    @woo.command(pass_context=True, aliases=['add'])
    ...
    @woo.command(pass_context=True, ignore_extra=False)
    ...
    @woo.command(pass_context=True, aliases=['delete'])
    ...
    @woo.command(pass_context=True, aliases=['owner'])
    ...
    @woo.command(name='list', pass_context=True)
